...
# The difference from 01-ocp-env-parameter.sh is that this script uses oc-mirror to download image.
...
# Download ocp image(oc-mirror
export IMAGE_SET_CONFIG_PATH="/root/mirror"
...
check_all_variables() {
    ...
    check_variable "IMAGE_SET_CONFIG_PATH"
