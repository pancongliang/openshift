...
export WORKER02_HOSTNAME="worker03"
...
export WORKER02_IP="10.74.249.234"
export WORKER03_IP="10.74.249.233"
export BOOTSTRAP_IP="10.74.253.52"
...
export HTTPD_PATH="/root/ocp-install"
export IGNITION_PATH="${HTTPD_PATH}/pre"

# === Do not change the following parameters ===
# oc-mirror plug-in for mirror image
export IMAGE_SET_CONFIGURATION_PATH="${HTTPD_PATH}"
