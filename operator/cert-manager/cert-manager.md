...
metadata:
  annotations:
    olm.providedAPIs: CertManager.v1alpha1.operator.openshift.io,Certificate.v1.cert-manager.io,CertificateRequest.v1.cert-manager.io,Challenge.v1.acmecert-manager.io,ClusterIssuer.v1.cert-manager.io,Issuer.v1.cert-manager.io,IstioCSR.v1alpha1.operator.openshift.io,Order.v1.acme.cert-manager.io
...
kube-scheduler                             4.16.29   True        True          False      46d     NodeInstallerProgressing: 1 node is at revision 35; 2nodes are at revision 36; 0 nodes have achieved new revision 37
...
kube-scheduler                             4.16.29   True        True          False      46d     NodeInstallerProgressing: 1 node is at revision 37; 2nodes are at revision 38; 0 nodes have achieved new revision 39
