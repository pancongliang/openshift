...
NAME     DESIRED                                            CONFIG-STATUS
master   rendered-master-14b94cd27b54d023036df6e8ead4a73c   rendered-master-14b94cd27b54d023036df6e8ead4a73c
worker   rendered-worker-0de55f4f91ac087adf8eb31463bfc043   rendered-worker-3251092830c3aaaf43eb2a185f621902

or

$ oc get mcp master -o jsonpath='{.spec.configuration.name}{"\n"}'
rendered-master-14b94cd27b54d023036df6e8ead4a73c
...
rendered-worker-0de55f4f91ac087adf8eb31463bfc043
...
$ oc patch node copan-t7d6v-worker-0-6v2w9 -p '{"metadata":{"annotations":{"machineconfiguration.openshift.io/desiredConfig":"rendered-worker-0de55f4f91ac087adf8eb31463bfc043"}}}' --type=merge
...
$ oc get nodes -l node-role.kubernetes.io/worker
NAME                         STATUS   ROLES    AGE    VERSION
copan-t7d6v-worker-0-6v2w9   Ready    worker   155m   v1.30.12
copan-t7d6v-worker-0-g6tvq   Ready    worker   155m   v1.30.12
copan-t7d6v-worker-0-qpl8q   Ready    worker   155m   v1.30.12
~~~
